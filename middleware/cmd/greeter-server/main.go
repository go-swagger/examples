...
import (
	...
	"github.com/go-swagger/examples/middleware/restapi"
...
func main() {
	...
	parser.ShortDescription = "greeter"
	parser.LongDescription = "Minimal API used to demonstrate how to plug custom net/http middleware\ninto a server generated by go-swagger.\n"
