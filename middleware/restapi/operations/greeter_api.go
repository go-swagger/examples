...
func NewGreeterAPI(spec *loads.Document) *GreeterAPI {
	return &GreeterAPI{
		...
		GreeterGreetHandler: greeter.GreetHandlerFunc(func(params greeter.GreetParams) middleware.Responder {
			_ = params

			return middleware.NotImplemented("operation greeter.Greet has not yet been implemented")
		}),

		GreeterGreetNameHandler: greeter.GreetNameHandlerFunc(func(params greeter.GreetNameParams) middleware.Responder {
			_ = params

			return middleware.NotImplemented("operation greeter.GreetName has not yet been implemented")
		}),
	}
}

/*
GreeterAPI Minimal API used to demonstrate how to plug custom net/http middleware
...
type GreeterAPI struct {
	...
	// GreeterGreetHandler sets the operation handler for the greet operation
	GreeterGreetHandler greeter.GreetHandler
	// GreeterGreetNameHandler sets the operation handler for the greet name operation
	GreeterGreetNameHandler greeter.GreetNameHandler
...
func (o *GreeterAPI) Validate() error {
	...
	if o.GreeterGreetHandler == nil {
		unregistered = append(unregistered, "greeter.GreetHandler")
	}
	if o.GreeterGreetNameHandler == nil {
		unregistered = append(unregistered, "greeter.GreetNameHandler")
	}
...
func (o *GreeterAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/greet"] = greeter.NewGreet(o.context, o.GreeterGreetHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/greet/{name}"] = greeter.NewGreetName(o.context, o.GreeterGreetNameHandler)
}
