...
type ClientService interface {
	...
	UpdateOneContext(ctx context.Context, params *UpdateOneParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*UpdateOneOK, *UpdateOneNoContent, error)
...
*/
func (a *Client) AddOneContext(ctx context.Context, params *AddOneParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*AddOneCreated, *AddOneNoContent, error) {
...
*/
func (a *Client) UpdateOneContext(ctx context.Context, params *UpdateOneParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*UpdateOneOK, *UpdateOneNoContent, error) {
	// NOTE: parameters are not validated before sending
	if params == nil {
