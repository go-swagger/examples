...
import (
	...
	"github.com/go-swagger/examples/tutorials/todo-list/server-2/restapi/operations"
	"github.com/go-swagger/examples/tutorials/todo-list/server-2/restapi/operations/todos"
)
