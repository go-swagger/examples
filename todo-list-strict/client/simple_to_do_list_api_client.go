...
import (
	...
	"github.com/go-swagger/examples/todo-list-strict/client/todos"
)
...
func New(transport runtime.ContextualTransport, formats strfmt.Registry) *SimpleToDoListAPI {
	// ensure nullable parameters have default
	if formats == nil {
...
func (c *SimpleToDoListAPI) SetTransport(transport runtime.ContextualTransport) {
