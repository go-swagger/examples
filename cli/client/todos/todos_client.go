...
type ClientService interface {
	...
	FindTodosContext(ctx context.Context, params *FindTodosParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*FindTodosOK, error)
...
/*
FindTodosfind todos API.

This method does not support injected context.
However, timeout and opentracing contexts are honored whenever enabled.

If you need to pass a specific context, use [Client.FindTodosContext] instead.
*/
func (a *Client) FindTodos(params *FindTodosParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*FindTodosOK, error) {
	...
	return a.FindTodosContext(ctx, params, authInfo, opts...)
}

/*
FindTodosContextfind todos API.

Do not use the deprecated [FindTodosParams.Context] with this method: it would be ignored.
*/
func (a *Client) FindTodosContext(ctx context.Context, params *FindTodosParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*FindTodosOK, error) {
	// NOTE: parameters are not validated before sending
	if params == nil {
